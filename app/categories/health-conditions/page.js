...
function HealthConditionsContent() {
  ...
  const subCategories = [
    { name: "Diabetes", count: 245 },
    { name: "Blood Pressure", count: 190 },
    { name: "Thyroid", count: 140 },
    { name: "Digestive Health", count: 210 },
    { name: "Joint & Bone", count: 175 },
    { name: "Mental Wellness", count: 120 },
    { name: "Respiratory", count: 160 },
    { name: "Eye & Ear Care", count: 95 },
  ];

  const brandOptions = ["Cipla", "Sun Pharma", "Dr. Reddy's", "Mankind", "Zydus", "Lupin", "Glenmark", "Torrent"];
  ...
  const mockProducts = [
    { _id: "h1", name: "Glucometer Easy Touch Strips (50 strips)", brand: "Accu-Chek", price: 650, mrp: 800, discount: "19%", rating: 4.7, reviews: 3400, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1698220522992_125.png", stock: 120, subCategory: "Diabetes", category: "Health Conditions" },
    { _id: "h2", name: "Telmisartan 40mg Tablet (10 tabs)", brand: "Cipla", price: 55, mrp: 65, discount: "15%", rating: 4.5, reviews: 1900, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1698220590032_127.png", stock: 350, subCategory: "Blood Pressure", category: "Health Conditions" },
    { _id: "h3", name: "Thyronorm 50mcg Tablet (120 tabs)", brand: "Abbott", price: 185, mrp: 210, discount: "12%", rating: 4.8, reviews: 4200, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1741163760626_122.png", stock: 280, subCategory: "Thyroid", category: "Health Conditions" },
    { _id: "h4", name: "Pantoprazole 40mg Tablet (15 tabs)", brand: "Sun Pharma", price: 72, mrp: 85, discount: "15%", rating: 4.6, reviews: 2800, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1756443365418_123.png", stock: 420, subCategory: "Digestive Health", category: "Health Conditions" },
    { _id: "h5", name: "Shelcal 500 Calcium Tablet (30 tabs)", brand: "Elder Pharma", price: 165, mrp: 195, discount: "15%", rating: 4.5, reviews: 2100, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1698220598279_128.png", stock: 200, subCategory: "Joint & Bone", category: "Health Conditions" },
    { _id: "h6", name: "Montelukast 10mg Tablet (10 tabs)", brand: "Cipla", price: 120, mrp: 145, discount: "17%", rating: 4.4, reviews: 1560, image: "https://assets.truemeds.in/Images/HomepageImage/Picture_1698220496491_124.png", stock: 310, subCategory: "Respiratory", category: "Health Conditions" },
  ];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const res = await fetch("/api/products?category=Health%20Conditions", { cache: "no-store" });
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto px-4 lg:px-6 py-4 flex items-center gap-2 text-xs text-gray-500">
        ...
        <ChevronRight size={12} />
        <span className="text-gray-900 font-medium">Health Conditions</span>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
              <div>
                <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-1">Health Conditions</h1>
      ...
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          <div className="text-center">
            ...
            <p className="text-gray-500 font-bold">Loading Health Conditions...</p>
          </div>
        </div>
      }
    >
